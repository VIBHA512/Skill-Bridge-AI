    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full">
        ...
        {step === 2 && (
          <div className="space-y-5 animate-fade-in">
            <div>
              <Label className="text-foreground mb-2 block">Target Role</Label>
              <Input
            ...
            <div>
              ...
              <Textarea
                placeholder="e.g., transitioning to management, system design"
            ...
            >
              {loading ? (
                ...
                <>
                  <Sparkles className="w-4 h-4 mr-2" /> Analyze My Career
                </>
              )}
            </Button>
          </div>
